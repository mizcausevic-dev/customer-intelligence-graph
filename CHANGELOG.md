...
### Released
- Published **customer-intelligence-graph** as a public, portfolio-grade SaaS revenue operations system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **customer-intelligence-graph**.
...
- That insight became the basis for **customer-intelligence-graph**.
